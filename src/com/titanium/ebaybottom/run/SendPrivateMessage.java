...
import com.titanium.ebaybottom.run.swebdriver.WebWindow;
	...
	public static void sendMessagesInQueue(
		...
		for (int i = 0; i < items.size(); i++) {
			...
			if (findMessageBodyTextbox() != null) {
				setInstantKeys(driver, PRIVATEMESSAGE_BODY_ID, selectedMessage
						.getValue().replace(Config.PERSONAL_MESSAGE_ADDON, ""));
